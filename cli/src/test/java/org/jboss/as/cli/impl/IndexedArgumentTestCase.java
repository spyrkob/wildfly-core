 ...
 */
public class IndexedArgumentTestCase {
    ...
    public void shouldAllowToAppearNextIfTheNameIsStarted() throws Exception {
        final IndexedArgument arg = new IndexedArgument(aHandler, "--foo");
    ...
    public void shouldAllowToAppearNextIfIndexIsCorect() throws Exception {
        final IndexedArgument arg = new IndexedArgument(aHandler, 0, "--foo");
    ...
    public void shouldNotAllowToIndexedArgToAppearNextIfPreviosArgumentForbitsIt() throws Exception {
        final IndexedArgument arg1 = new IndexedArgument(aHandler, 0, "exclusive");
        final IndexedArgument arg2 = new IndexedArgument(aHandler, 1, "--foo");
    ...
    public void shouldNotAllowArgumentIfRequiredPrecedingArgIsNotPresent() throws Exception {
        final IndexedArgument arg0 = new IndexedArgument(aHandler, -1, "--bar");
        final IndexedArgument arg1 = new IndexedArgument(aHandler, -1, "--foo");
